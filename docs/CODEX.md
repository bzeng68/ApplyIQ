...
ApplyIQ supports Codex through the root `AGENTS.md` file.
...
- Node.js 18+
- Playwright Chromium installed for liveness checks and batch evaluation
...
- `Evaluate this job URL with ApplyIQ and run the full pipeline.`
...
ApplyIQ modes and scripts rather than introducing a parallel automation layer.
